...
**Collected**: 2026-05-31 01:28 UTC
### HCC 2026-04.pdf
...
```json
{
  ...
  "needs_review": 98,
  "payee_rules_applied": 0,
  "payee_rows_changed": 0,
  "payee_rules_total": 0,
  "payee_merge_count": 1,
  ...
  "log_excerpt": [
    ...
    "[OK] Azure Document Intelligence: 98 transaction(s) in 21.57s.",
...
```json
{
  ...
  "log_excerpt": [
    ...
    "[OK] Azure Document Intelligence: 94 transaction(s) in 15.16s.",
