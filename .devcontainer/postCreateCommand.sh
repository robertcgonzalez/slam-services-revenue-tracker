...
_blue "----------------------------------------------------------------"
_blue " Local Enhanced OCR (v2.43.2) defaults for Codespaces:"
echo "   SLAM_LOCAL_OCR_DPI_TEXT=200   (was 300 on Robert's local Windows)"
echo "   SLAM_LOCAL_OCR_DPI_CROP=180   (was 250 on Robert's local Windows)"
echo "   SLAM_LOCAL_OCR_MAX_PAGES_RASTER=20"
echo "   SLAM_LOCAL_OCR_MAX_CHECKS=30"
