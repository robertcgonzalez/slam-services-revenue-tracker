...
**Status (May 24, 2026 — v2.25)**: Phase 2.5 P0–P2 app fixes complete in `App/app.py`. GitHub Actions deploy hardened; set `AZUREAPPSERVICEPUBLISHPROFILE` for CI or use manual zip deploy. See Blueprint Section 14.2 Status column.
...
**Deploy note (v2.25):** Confirm live Azure after CI secret or manual zip deploy. P1 data script (`generate_revenue_data.py` Payroll/Tax prep rows) remains optional follow-up.
